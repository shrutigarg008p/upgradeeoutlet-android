...
public class PlacesAutoCompleteAdapter extends RecyclerView.Adapter<PlacesAutoCompleteAdapter.PredictionHolder> implements Filterable {
        ...
        if (autocompletePredictions.isSuccessful()) {
            ...
            if (findAutocompletePredictionsResponse != null)
                for (AutocompletePrediction prediction : findAutocompletePredictionsResponse.getAutocompletePredictions()) {
                    ...
                    Log.e("resultList", Arrays.toString(resultList.toArray()));
                }
    ...
    public PredictionHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        if (MySharedPreferenceClass.getChoosenlanguage(mContext) != null) {
            if (MySharedPreferenceClass.getChoosenlanguage(mContext).equals("ar")) {
                convertView = layoutInflater.inflate(R.layout.place_recycler_item_layout_arabic, viewGroup, false);
            } else if (MySharedPreferenceClass.getChoosenlanguage(mContext).equals("en")) {

                convertView = layoutInflater.inflate(R.layout.place_recycler_item_layout, viewGroup, false);
            } else {
                convertView = layoutInflater.inflate(R.layout.place_recycler_item_layout_arabic, viewGroup, false);
            }
        } else {
    ...
    public void onBindViewHolder(@NonNull PredictionHolder mPredictionHolder, final int i) {
        Log.e("mResultList size", String.valueOf(mResultList.size()));
